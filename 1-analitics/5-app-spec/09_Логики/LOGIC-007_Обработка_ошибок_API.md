# LOGIC-007. Обработка ошибок API
...
Единый маппинг ErrorCode, field errors, 401, бизнес-отказов и сетевых ошибок в UI.
...
|---|---|---|
| Все SCR | см. связанные экраны | Всегда при выполнении сценария |
...
Прямых API-запросов нет; логика применяется как общий обработчик.
